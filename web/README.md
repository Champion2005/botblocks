...
- [Getting Started](docs/getting-started.md) — Setup, first script, adding AI
- [Architecture](docs/architecture.md) — System overview, data flow, key files
- [Python API](docs/python-api.md) — `Robot`, `Camera`, `Burger`, `AI`, `Tool`, hooks
- [AI System](docs/ai-system.md) — Providers, agent loop, built-in tools, custom tools
- [Simulation](docs/simulation.md) — Renderer, World, Robot physics, Vision
- [TypeScript API](docs/typescript-api.md) — Internal classes and interfaces
